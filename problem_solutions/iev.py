...
def calc_expected_offspring(n_couples):
    phenotype_prob = {
        0: 1.0,
        1: 1.0,
        2: 1.0,
    ...
    X = 0
    for i, couple in enumerate(n_couples):
        X += phenotype_prob[i] * 2 * couple
...
def main():
    try:
        ...
        answer = calc_expected_offspring(data)
        print(answer)
...
if __name__ == '__main__':
    ...
    assert calc_expected_offspring([1, 0, 0, 1, 0, 1]) == 3.5
